package com.example.nirahurk.memecreator;
...
public class MainActivity extends ActionBarActivity implements TopSectionFragment.TopSectionListener {
    ...
    public void createClick(String top, String bottom) {
        BottomFixtureFragment bottomFragment = (BottomFixtureFragment)getSupportFragmentManager().findFragmentById(R.id.fragment2);
